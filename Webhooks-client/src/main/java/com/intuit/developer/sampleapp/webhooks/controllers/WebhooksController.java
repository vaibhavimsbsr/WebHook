...
//https://github.com/IntuitDeveloper/SampleApp-Webhooks-Java
/**
...
public class WebhooksController {
    ...
    @RequestMapping(value = "/webhooks1", method = RequestMethod.POST)
    @ResponseBody
    public ResponseEntity<ResponseWrapper> webhooks1(@RequestHeader(SIGNATURE) String signature, @RequestBody String payload) {
